...
export function Photography() {
  ...
  useGSAP(
    ...
    { scope: sectionRef, dependencies: [images.length, appReady] },
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        ...
        {images.length > 0 ? (
          <div className="mt-12 grid auto-rows-[140px] grid-cols-2 gap-2 sm:auto-rows-[200px] sm:gap-4 md:grid-cols-4">
